...
export var ThemeSwitcher = function (_a) {
    ...
    return (_jsx(Button, __assign({ theme: ButtonTheme.CLEAR, onClick: toggleTheme, className: classNames('', {}, [className]) }, { children: theme === Theme.DARK ? _jsx(DarkIcon, {}) : _jsx(LightIcon, {}) })));
};
